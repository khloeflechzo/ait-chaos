...
const Button = ({
  ...
  return (
    <div onClick={onClick} className={buttonClasses}>
      <SvgInsert src={`/icons/buttons/corner/green.svg`} className={cn(s.corner, s.corner__left)} />
      <div className={s.button__slice}></div>
      <SvgInsert
        src={`/icons/buttons/corner/green.svg`}
        className={cn(s.corner, s.corner__right)}
      />
